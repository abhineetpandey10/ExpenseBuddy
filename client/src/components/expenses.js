...
export default function Expenses(props)
{
    ...
    async function refreshData(pageno)
    {
        ...
        let url="https://expense-buddy-server.herokuapp.com/expenses/get"+"?uid="+uid+'&from='+from+'&to='+to+'&filter='+filter+'&pageno='+pageno;
    ...
    async function createNewExpense()
    {
        ...
        else
        {
            ...
            fetch("https://expense-buddy-server.herokuapp.com/expenses/add", requestOptions)
            .then(response => response.text())
            .then(result => {
                setMessage(result);
                if(result==='Success')
