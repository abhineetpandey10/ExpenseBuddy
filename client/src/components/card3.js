...
export default function Card3(props)
{
    ...
    function deleteTransaction()
    {
        ...
        fetch("https://expense-buddy-server.herokuapp.com/expenses/delete", requestOptions)
        .then(()=>{
            setProcessing(false);
            setVisible(false);
    ...
    function updateTransaction()
    {
        ...
        fetch("https://expense-buddy-server.herokuapp.com/expenses/update", requestOptions)
