...
export default function Reports(props)
{
    ...
    async function fetchWeeklyData(currency)
    {
        ...
        let url="https://expense-buddy-server.herokuapp.com/reports/weekly?uid="+uid+"&currency="+currency+"&weekno=";
    ...
    async function fetchCategoryWiseData(currency)
    {
        ...
        var requestOptions = {
          ...
          let uid=await localStorage.getItem('uid');
          let url="https://expense-buddy-server.herokuapp.com/reports/categorywise?uid="+uid+"&currency="+currency
